...
describe("F002 - Crear post", () => {
    ...
    it("E00201 - Crear un post y publicarlo", () => {
        ...
        cy.request({
            ...
            cy.postEditorPage.createAndPublishPost(postTitle, postUrl, text);
    ...
    it("E00202 - Crear un borrador de un post", () => {
        ...
        cy.request({
            ...
            // When
            cy.log(`When I type a post title "${postData.title}"`);
            cy.postEditorPage.setTitle(postData.title);
            ...
            // Then
            cy.log(
                `Then I should see a post "${postData.title}" in the post list flagged as draft`
            );
            cy.postListPage.visit();
            const post = cy.postListPage.getPostFromList(postData.title);
